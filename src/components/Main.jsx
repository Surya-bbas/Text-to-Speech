            ...
            <div className='object-contain flex flex-col items-center  '>
                <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600  w-3/4">
                    ...
                    <div className='flex flex-col items-center py-4'>
                        <button type="button" className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800  md:text-2xl" onClick={click}>
                            Convert
                        </button>
                    </div>
                </div>
